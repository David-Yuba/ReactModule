   ...
   const fields = [
    {
      ...
      maxLength: { enabled: true, value: 20, message: "Ime može imati najviše 20 znakova." }
    },
    {
      name: "email",
      label: "Email",
    ...
    },
    {
      ...
      required: true,
      placeholder: "npr. 25",
      range: { enabled: true, min: 18, max: 65, message: "Godine moraju biti između 18 i 65." }
    },
    {
      name: "opis",
      label: "Kratki opis",
      ...
      rows: 4,
      maxLength: { enabled: true, value: 120, message: "Opis može imati najviše 120 znakova." }
    },
    {
      name: "grad",
      label: "Grad",
      ...
      required: true,
      options: [
        {label:"Zagreb", value: "ZG"},
        {label:"Split", value: "ST"},
        {label:"Rijeka", value: "RI"},
      ],
